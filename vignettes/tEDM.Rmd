...
Building on the results of CCM, we further test the direct causal influences of other air pollutants on CVDs using PCM.

```{r pcm_cvd, eval=FALSE, echo=FALSE}
p1 = tEDM::pcm(cvd,"rsp","cvd",c("no2","o3"),,libsizes = seq(32,1032,100),E = 5,k = c(6,6,8,6),progressbar = FALSE)
p1
p2 = tEDM::pcm(cvd,"no2","cvd",c("rsp","o3"),,libsizes = seq(32,1032,100),E = 5,k = c(8,6,6,6),progressbar = FALSE)
p2
p3 = tEDM::pcm(cvd,"o3","cvd",c("rsp","no2"),,libsizes = seq(32,1032,100),E = 5,k = c(6,6,6,8),progressbar = FALSE)
p3
```
...
```{r fig_case2,fig.width=4.5,fig.height=4.5,fig.dpi=100,fig.cap=knitr::asis_output("**Figure 3**. Causal strength scores between annual mean temperature and total annual CO₂ emissions across US counties, with embedding dimension E set to 6 and number of neighbors set to 20.")}
