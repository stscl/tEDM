...
rsp_cvd
no2_cvd = tEDM::ccm(cvd,"no2","cvd",libsizes = seq(10,1300,100), E = 5,k = c(8,6))
no2_cvd
so2_cvd = tEDM::ccm(cvd,"so2","cvd",libsizes = seq(10,1300,100), E = 5,k = c(15,6))
so2_cvd
o3_cvd = tEDM::ccm(cvd,"o3","cvd",libsizes = seq(10,1300,100), E = 5,k = 6)
o3_cvd
```
